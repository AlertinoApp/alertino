...
export function CTASection({ user }: CTASectionProps) {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-background via-muted/20 to-emerald-50/30 dark:from-background dark:via-muted/10 dark:to-emerald-950/5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-emerald-600/12 to-emerald-700/8 dark:from-blue-500/18 dark:to-indigo-500/12 rounded-full blur-2xl"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center bg-emerald-600/10 dark:bg-emerald-400/10 backdrop-blur-sm border border-emerald-600/20 dark:border-emerald-400/20 rounded-full px-6 py-3 text-emerald-700 dark:text-emerald-300 font-medium">
          ...
          >
            <Button
              ...
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-lg px-12 py-6 rounded-2xl shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
            >
